...
creator=["",mid,Amid,Bmid,Cmid]
owner=["",mid,Amid,Bmid,Cmid]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"TERIMA KASIH KAK UDAH DI ADD",
    "lang":"JP",
    "comment":"http:/line.me/ti/p/~boy29putra",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#--------------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,mid)
#--------------------------------------------------
            elif "dh1 mid" == msg.text:
				if msg.from_ in admin:
					cl.sendText(msg.to,Amid)
#--------------------------------------------------
            elif "and mid" == msg.text:
				if msg.from_ in admin:
					cl.sendText(msg.to,Bmid)
#--------------------------------------------------
            elif "You mid" == msg.text:
				if msg.from_ in admin:
					kc.sendText(msg.to,Cmid)
#--------------------------------------------------
...
#-----------------------------------------------
                              ...
                              cnt.to = msg.to
                              cl.sendText(msg.to,"SUN SUCCESS")
                              cl.sendMessage(cnt)
#-----------------------------------------------
...
#-----------------------------------------------
					...
					cl.sendText(msg.to,"Bang Aji")
					ki.sendMessage(msg)
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u9cc2323f5b84f9df880c33aa9f9e3ae1"}
					cl.sendText(msg.to,"Ban Aji")
					cl.sendText(msg.to,"SiGanteng Yang imuet!!")
					ki.sendMessage(msg)
